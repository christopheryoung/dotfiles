...
(custom-set-variables
 ...
 '(package-selected-packages
   '(org-roam-ui helm-bibtex helm-org python-mode org-ref webfeeder deft
		 use-package sqlite3 org-roam dumb-jump alert lsp-ui
		 wrap-region wgrep undo-tree smex s repository-root
		 rainbow-delimiters python-pylint python-pep8 pymacs pylint
		 projectile paredit multiple-cursors multi-term maxframe
		 markdown-mode mark-multiple magit loop leuven-theme
		 latex-extra jump-char json-mode ipython intero igrep iedit
		 idle-highlight-mode hydra ht helm-gtags grizzl git-timemachine
		 git-messenger git-gutter ggtags find-file-in-repository
		 fill-column-indicator expand-region exec-path-from-shell
		 erlang elpy ebib discover dired-details diminish csv-mode
		 cquery clang-format auto-complete ace-jump-mode))
 '(sort-fold-case t t))
(custom-set-faces
