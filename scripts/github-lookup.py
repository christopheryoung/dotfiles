#!/usr/bin/python
# Modified only very slightly from: https://raw.github.com/reinout/tools/master/tools/github.py
"""
Opens github page for your current directory in your browser.

Suppose you're working on the commandline and want to check something for the
github project you're working on. This script looks up the github url for your
project and opens it in your webbrowser.
